...
<<<<<<< HEAD
            string cs = "Data Source=LAPTOP-9ONODM5O;Initial Catalog=PROYECTOFINALWEB;Integrated Security=True";
=======
            string cs = "Data Source=DESKTOP-P3TEKEM;Initial Catalog=PROYECTOFINALWEB;Integrated Security=True";
