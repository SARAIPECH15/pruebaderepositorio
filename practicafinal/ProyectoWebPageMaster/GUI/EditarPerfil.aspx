          ...
          function ImagePreview(input) {
              if (input.files && input.files[0]) {
                  ...
                  reader.onload = function (e) {
                      $('#<%=imgperfilusuario.ClientID%>').prop('src', e.target.result)
                          .width(210)
                          .height(210);
                  };
    ...
    <!-- end normal -->
     <!--  <img src="../recursos/img/fotos_perfil/perfil.jpg" alt="img">  -->
             ...
             <div class="custom-file">
                    <asp:FileUpload CssClass="custom-file-input" ID="Fu_perfil" runat="server" onchange="ImagePreview(this);javascript:cambiar_nombre()"  Visible="true">  </asp:FileUpload>
            ...
            <div class="card-body">
                ...
                <asp:DropDownList ID="DropDownPais" runat="server" AutoPostBack="true" OnSelectedIndexChanged="DropDownPais_SelectedIndexChanged"></asp:DropDownList>&nbsp&nbsp
                ...
                <br />
                <asp:Button ID="btnactualizar" runat="server" Text="Guardar" CssClass="btn btn-warning" OnClick="btnactualizar_Click" />
         </div>
            </div>
