...
{
    public partial class GenerosABC : System.Web.UI.Page
    {
        ...
        protected void btn_ActualizarGen_Click(object sender, EventArgs e)
        {
            llenarbo();
            objGenBO.CODIGO_GEN1 = int.Parse(txt_IDGen.Text);
